# Team XJTLU Museum Project 2025 Wiki

This repository **MUST** contain all coding assets to generate your team's wiki (HTML, CSS, JavaScript, TypeScript, Python, etc).

Images, photos, icons and fonts should be stored on an external static asset host, and videos should be embedded from a reliable video platform.
